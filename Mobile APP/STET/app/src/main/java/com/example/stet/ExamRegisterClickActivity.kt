...
class ExamRegisterClickActivity : AppCompatActivity() {
    //containing menu bar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadLocate()
        setContentView(R.layout.register_click)
        ...
        callx!!.enqueue(object : Callback<Void?> {
            override fun onResponse(
                ...
                if (response.code() == 201) {
                    ...
                    Toast.makeText(
                        this@ExamRegisterClickActivity, getString(R.string.logkro),
                        Toast.LENGTH_LONG
                    ).show()
                    val i = Intent(this@ExamRegisterClickActivity, MainActivity::class.java)
                    startActivity(i)
                    ...
                    Toast.makeText(
                        this@ExamRegisterClickActivity, getString(R.string.toastslowinternet),
                        Toast.LENGTH_LONG
                    ).show()
            ...
            override fun onFailure(
                ...
                Toast.makeText(
                    this@ExamRegisterClickActivity, getString(R.string.poorinternet),
                    Toast.LENGTH_LONG
                ).show()
        ...
        //check for user
            ...
            exam_register_btn.setOnClickListener {
                if (x != 0) {
                    if (t == 1) {
                        ...
                        Toast.makeText(
                            this@ExamRegisterClickActivity,
                ...
                call!!.enqueue(object : Callback<Void?> {
                    override fun onResponse(
                        ...
                        if (response.code() == 200) {
                            ...
                            Toast.makeText(
                                this@ExamRegisterClickActivity, getString(R.string.toastwrong),
                                Toast.LENGTH_LONG
                            ).show()
    ...
    private fun showChangeLang() {
        ...
        val mBuilder = AlertDialog.Builder(this@ExamRegisterClickActivity)
