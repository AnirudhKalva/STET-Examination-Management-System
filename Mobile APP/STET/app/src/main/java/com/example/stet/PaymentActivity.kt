        ...
        callx!!.enqueue(object : Callback<Void?> {
            override fun onResponse(
                ...
                if (response.code() == 201) {
                    ...
                    Toast.makeText(
                        this@PaymentActivity, getString(R.string.logkro),
                        Toast.LENGTH_LONG
                    ).show()
                    ...
                    Toast.makeText(
                        this@PaymentActivity, getString(R.string.toastslowinternet),
                        Toast.LENGTH_LONG
                    ).show()
            ...
            override fun onFailure(
                ...
                Toast.makeText(
                    this@PaymentActivity, getString(R.string.poorinternet),
                    Toast.LENGTH_LONG
                ).show()
        ...
        override fun onPaymentSuccess(rzpPaymentId: String?, paymentData: PaymentData?) {
            ...
            call!!.enqueue(object : Callback<Void> {
                override fun onFailure(call: Call<Void>, t: Throwable) {
                    Toast.makeText(this@PaymentActivity,getString(R.string.poorinternet),Toast.LENGTH_SHORT).show()
                }
                ...
                override fun onResponse(call: Call<Void>, response: Response<Void>) {
                    ...
                    {
                        Toast.makeText(this@PaymentActivity,getString(R.string.paymentstored),Toast.LENGTH_SHORT).show()
                    }
