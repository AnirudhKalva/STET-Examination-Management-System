        ...
        signup_verify.setOnClickListener {
            ...
            if (validName(page_1_signup_name_et) == 0 && validEmail(page_1_signup_email_et) == 0
                && validNumber(
                    ...
                    10
                ) == 0 && isValidPassword(page_1_signup_Edtpass) == 0
            ) {
                ...
                call1!!.enqueue(object : Callback<Void?> {
                    ...
                    override fun onFailure(
                        ...
                        Toast.makeText(
                            this@SignupActivity, getString(R.string.poorinternet),
                            Toast.LENGTH_LONG
                        ).show()
                        progress.dismiss()
                    }
                ...
                progress.dismiss()
                Toast.makeText(this@SignupActivity, getString(R.string.checkerror), Toast.LENGTH_SHORT).show()
            }
        }
